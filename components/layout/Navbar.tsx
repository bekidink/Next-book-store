                    ...
                    <div >
                        {
                            ...
                            <button onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                                <Image src={avatarImg} alt="" className={`size-7 rounded-full ${currentUser ? 'ring-2 ring-blue-500' : ''}`} />
                            </button>
                            {/* show dropdowns */}
                            {
                                isDropdownOpen && (
                            ...
                            </> : token ?  <Link href="/dashboard" className='border-b-2 border-primary'>Dashboard</Link> : (
